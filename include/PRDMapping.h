...
class PRDMapping /*: public TObject*/ {
...
public:
  ...
  static PRDMapping * GetInstance() {
    if (instance == 0) instance = new PRDMapping() ;
    return instance;
  }
...
private:
  ...
  PRDMapping() {fNbOfAPVs = 0;}

  static PRDMapping * instance;
  Int_t fNbOfAPVs ;
