...
class GEMCluster: public TObject{
 ...
 public:
  GEMCluster(Int_t minClusterSize, Int_t maxClusterSize, TString isMaximumOrTotalCharges) ;
 ~GEMCluster();
  ...
  void SetAPVIndexOnPlane(Int_t nb) {fapvIndexOnPlane = nb;}
 ...
 private:
  ...
  Int_t         fNbOfHits;     // numbers of strips with hit
