...
GEMHistoManager::GEMHistoManager()
{
  ...
  histo_file = new TFile("./results/histos.root", "recreate");
}
...
void GEMHistoManager::BookHistos()
{
  for(int i=0;i<nbDetector;i++)
  {
    ...
    hhClusterDist[i] -> SetDirectory(histo_file);
    ...
    hhStripHitDist[i] -> SetDirectory(histo_file);
    ...
    hhClusterDist_pRad[i] -> SetDirectory(histo_file);
    ...
    hhChargeRatio[i] -> SetDirectory(histo_file);
    ...
    hChargeRatio[i] -> SetDirectory(histo_file);
    ...
    hClusterADCDistXSide[i] -> SetDirectory(histo_file);
    ...
    hClusterADCDistYSide[i] -> SetDirectory(histo_file);
    ...
    hNbClusterPerPlaneX[i] -> SetDirectory(histo_file);
    ...
    hNbClusterPerPlaneY[i] -> SetDirectory(histo_file);
    ...
    hClusterDistX[i] -> SetDirectory(histo_file);
    ...
    hClusterDistY[i] -> SetDirectory(histo_file);
  ...
  hQuantityOfClustersHyCal->SetDirectory(histo_file);
  ...
  hQuantityOfClustersGEMBeforeMatch->SetDirectory(histo_file);
  ...
  hQuantityOfClustersGEMAfterMatch->SetDirectory(histo_file);
  ...
  hhGEMClusterMap -> SetDirectory(histo_file);
  ...
  hhGEMClusterMapAfterMatch -> SetDirectory(histo_file);
  ...
  hhGEMClusterMapSingleCluster -> SetDirectory(histo_file);
  ...
  hhGEMClusterMapMaxTwoCluster -> SetDirectory(histo_file);
  ...
  hhHyCalClusterMap -> SetDirectory(histo_file);
  ...
  hhGEMClusterMapHyCal2GEM1 -> SetDirectory(histo_file);
  ...
  hhHyCalClusterMapHyCal2GEM1 -> SetDirectory(histo_file);
  ...
  hhHyCalClusterMap2ClusterBeforeMatch -> SetDirectory(histo_file);
  ...
  hhGEMClusterMap2ClusterAfterMatch -> SetDirectory(histo_file);
  ...
  hHyCalEnergy -> SetDirectory(histo_file);
  ...
  hHyCalEnergyEp -> SetDirectory(histo_file);
  ...
  hHyCalEnergyMoller -> SetDirectory(histo_file);
  ...
  hThetaDistribution -> SetDirectory(histo_file);
  ...
  hThetaDistributionEp -> SetDirectory(histo_file);
  ...
  hThetaDistributionMoller -> SetDirectory(histo_file);
  ...
  hThetaDistributionMollerBeamLineCorrection -> SetDirectory(histo_file);
  ...
  hThetaDistributionMollerLarge -> SetDirectory(histo_file);
  ...
  hThetaDistributionMollerSmall -> SetDirectory(histo_file);
  ...
  hThetaDistributionMollerSlice -> SetDirectory(histo_file);
  ...
  hLinearDeviationMoller -> SetDirectory(histo_file);
  ...
  hQSquareEp -> SetDirectory(histo_file); 
  ...
  hQSquareEp1 -> SetDirectory(histo_file); 
  ...
  hQSquareEp2 -> SetDirectory(histo_file); 
  ...
  hQSquareEp3 -> SetDirectory(histo_file); 
  ...
  hQSquareEp4 -> SetDirectory(histo_file);
  ...
  hQSquareEp5 -> SetDirectory(histo_file);
  ...
  hhQSquareScattAngleEp -> SetDirectory(histo_file);
  ...
  hhEnergyVsAngle -> SetDirectory(histo_file);
  ...
  hhEnergyVsAngleEnergyCut -> SetDirectory(histo_file);
  ...
  hhEnergyVsAngleBeamLineCorrection -> SetDirectory(histo_file); 
  ...
  hhEnergyVsAngleEp -> SetDirectory(histo_file); 
  ...
  hhEnergyVsAngleEpEnergyCut -> SetDirectory(histo_file);
  ...
  hhEnergyVsAngleMoller -> SetDirectory(histo_file); 
  ...
  hhEnergyVsAngleMollerEnergyCut -> SetDirectory(histo_file);
  ...
  hhEnergyVsAngleMollerBeamLineCorrection  -> SetDirectory(histo_file);
  ...
  hhEnergyVsAngleHyCal2CGEM1C -> SetDirectory(histo_file); 
  ...
  hXOffsetFromMoller -> SetDirectory(histo_file); 
  ...
  hYOffsetFromMoller -> SetDirectory(histo_file); 
  ...
  hhMollerCenter -> SetDirectory(histo_file); 
  ...
  hXOffsetFromSymmetricMoller -> SetDirectory(histo_file); 
  ...
  hYOffsetFromSymmetricMoller -> SetDirectory(histo_file);
  ...
  hhSymmetricMollerCenter -> SetDirectory(histo_file);
  ...
  hSymmetricMollerTheta -> SetDirectory(histo_file);
  ...
  hXOffsetFromMollerAfterCorrection -> SetDirectory(histo_file);
  ...
  hYOffsetFromMollerAfterCorrection -> SetDirectory(histo_file);
  ...
  hhMollerCenterAfterCorrection -> SetDirectory(histo_file);
  ...
  hLinearDeviationMollerAfterCorrection -> SetDirectory(histo_file);
  ...
  hXOffsetGEM -> SetDirectory(histo_file);
  ...
  hROffsetGEMHyCal -> SetDirectory(histo_file);
  ...
  hYOffsetGEM -> SetDirectory(histo_file);
  ...
  hXOffsetGEMAfterCorrection -> SetDirectory(histo_file);
  ...
  hYOffsetGEMAfterCorrection -> SetDirectory(histo_file);
  ...
  hhMoller2DRing -> SetDirectory(histo_file);
  ...
  hhMoller2DRing2 -> SetDirectory(histo_file); 
  ...
  hhMoller2DRingBeforeMatch -> SetDirectory(histo_file); 
  ...
  hhMoller2DRingBeforeMatch2 -> SetDirectory(histo_file);
  ...
  hXDiffMatch -> SetDirectory(histo_file);
  ...
  hYDiffMatch -> SetDirectory(histo_file);
  ...
  hhXDiffMatchVsEnergy -> SetDirectory(histo_file);
  ...
  hhYDiffMatchVsEnergy -> SetDirectory(histo_file);
  ...
  hNbPointsMatch -> SetDirectory(histo_file);
  ...
  hhTimeCorrelation -> SetDirectory(histo_file);
  hTimeDiff -> SetDirectory(histo_file);

}

void GEMHistoManager::WriteHistos()
{

    // gem charatorization
    TDirectory * gem = histo_file->mkdir("GEM_Charactorization");
    gem->cd();
    ...
    TDirectory * gem_hycal = histo_file->mkdir("GEM_HyCal_charatorization");
    gem_hycal->cd();
    hhGEMClusterMap->Write();
    hhGEMClusterMapAfterMatch->Write();
    ...
    hQuantityOfClustersHyCal->Write();
    hQuantityOfClustersGEMBeforeMatch->Write();
    hQuantityOfClustersGEMAfterMatch->Write();

    // theta distribution
    TDirectory * theta = histo_file->mkdir("Theta_Distribution_coplanarity");
    theta->cd();
    ...
    TDirectory * q_square = histo_file->mkdir("Q_Square_Distribution");
    q_square->cd();
    hQSquareEp->Write();
    hQSquareEp1->Write();
    hQSquareEp2->Write();
    ...
    // every vs angle
    TDirectory * energyangle = histo_file->mkdir("Energy_Angle");
    energyangle->cd();
    hhEnergyVsAngle->Write();
    hhEnergyVsAngleMoller->Write();
    hhEnergyVsAngleEp->Write();
    hhEnergyVsAngleEnergyCut->Write();
    hhEnergyVsAngleMollerEnergyCut->Write();
    hhEnergyVsAngleEpEnergyCut->Write();
    ...
    TDirectory * hycal2gem1 = histo_file->mkdir("HyCal2Cluster_GEM1Cluster");
    hycal2gem1->cd();
    ...
    // offset
    TDirectory * offset = histo_file -> mkdir("Offsets");
    offset->cd();
    ...
    hXOffsetGEM->Write();
    hYOffsetGEM->Write();
    hROffsetGEMHyCal->Write();
    hXOffsetGEMAfterCorrection->Write();
    hYOffsetGEMAfterCorrection->Write();


    // moller ring
    TDirectory *moller_ring = histo_file->mkdir("Moller_Ring");
    moller_ring->cd();
    ...
    // hycal gem match
    TDirectory * hycal_match = histo_file->mkdir("Hycal_GEM_Match");
    hycal_match->cd();
    hXDiffMatch->Write();
    hYDiffMatch->Write();
    ...
    // un-relative
    TDirectory * u = histo_file->mkdir("time_correlation");
    u->cd();
